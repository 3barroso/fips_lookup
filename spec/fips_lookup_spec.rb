  ...
  describe ".subdivision" do
    context "with valid subdivision param" do
      it "returns the corresponding subdivision row hash" do
        expect(FipsLookup.subdivision(state_param: "CO", subdivision_param: "North Aurora CCD")).to eq({state_code: "CO", fips: "0800192622", county_name: "Adams County", gnis: "01935531", name: "North Aurora CCD", class_code: "Z5", status: "S"})
      end
    end
  end
